...
description: Responsible AI Seed Principles for coding agents working in this repository
---

# Responsible AI Seed Principles — Agent Instructions

This document tells AI coding agents how to behave when working in this repository. It operationalizes UC's Responsible AI Principles as concrete rules, not ideals to aspire to. Follow these rules in every task: planning, code, tests, docs, comments, and commit messages.
